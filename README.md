...
-- Allowed users list
local testUsers = {
    "Klaywessels_48171", "Vealskylab", "Xdemon123679", "psychopowerful049", "psychopowerful90",
...
local buttonsPagesData = {{
    ...
    {Text = "Aura", ScriptLink = "https://pastebin.com/raw/ctnfTnpd"},
    ...
    {Text = "Damage hitbox", ScriptLink = "https://pastebin.com/raw/FqiXk4iz"},
